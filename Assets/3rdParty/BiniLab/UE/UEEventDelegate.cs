...
public class UEEventDelegate
{
	...
	public UEEventDelegate () { }
	public UEEventDelegate (Callback call) { Set(call); }
	public UEEventDelegate (MonoBehaviour target, string methodName) { Set(target, methodName); }
	...
	public override bool Equals (object obj)
	{
		...
		if (obj is UEEventDelegate)
		{
			UEEventDelegate del = obj as UEEventDelegate;
	...
	static public void Execute (List<UEEventDelegate> list)
	{
		if (list != null)
		{
	...
	static public bool IsValid (List<UEEventDelegate> list)
	{
		if (list != null)
		{
	...
	static public UEEventDelegate Set (List<UEEventDelegate> list, Callback callback)
	{
		if (list != null)
		{
			UEEventDelegate del = new UEEventDelegate(callback);
			list.Clear();
			list.Add(del);
			return del;
		}
	...
	static public void Set (List<UEEventDelegate> list, UEEventDelegate del)
	{
		if (list != null)
		{
			list.Clear();
	...
	static public UEEventDelegate Add (List<UEEventDelegate> list, Callback callback) { return Add(list, callback, false); }
	...
	static public void Add (List<UEEventDelegate> list, UEEventDelegate ev) { Add(list, ev, ev.oneShot); }
	...
	static public bool Remove (List<UEEventDelegate> list, Callback callback)
	{
		if (list != null)
		{
			for (int i = 0, imax = list.Count; i < imax; ++i)
