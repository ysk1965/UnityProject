...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UEScrollSnapBase : MonoBehaviour, IBeginDragHandler, IDragHandler, IScrollSnap
    {
        ...
        void Awake()
        {
            ...
            {
                var hscroll = _scroll_rect.horizontalScrollbar.gameObject.AddComponent<UEScrollSnapScrollbarHelper>();
                hscroll.ss = this;
            }
            if (_scroll_rect.verticalScrollbar && _scroll_rect.vertical)
            {
                var vscroll = _scroll_rect.verticalScrollbar.gameObject.AddComponent<UEScrollSnapScrollbarHelper>();
                vscroll.ss = this;
            }
